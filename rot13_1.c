/*
** Automatically generated from `rot13_1.m'
...
/* sealed */ struct rot13_1__vector_common_type_1_0_s {
  const MR_Char rot13_1__vector_common_type_1_0__vct_1_f_0;
};

static /* final */ const struct rot13_1__vector_common_type_1_0_s rot13_1_vector_common_1[58];
      ...
      case (MR_Integer) 1:
        {
          ...
          if ((((MR_Unsigned) ((MR_Integer) ((MR_Unsigned) Char_5 - (MR_Unsigned) 65))) <= ((MR_Unsigned) 57)))
            ...
            {
              CharOut_22 = ((&rot13_1_vector_common_1[0 + (MR_Integer) ((MR_Unsigned) Char_5 - (MR_Unsigned) 65)]))->rot13_1__vector_common_type_1_0__vct_1_f_0;
              succeeded = MR_TRUE;
            }
            else
              succeeded = MR_FALSE;
...
void mercury__rot13_1__init(void)
{
}

void mercury__rot13_1__init_type_tables(void)
{
}

void mercury__rot13_1__init_debugger(void)
{
	MR_fatal_error("debugger initialization in MLDS grade");
}

// Ensure everything is compiled with the same grade.
const char *mercury__rot13_1__grade_check(void)
{
    return &MR_GRADE_VAR;
}
